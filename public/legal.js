  ...
  terms: {
    ...
    sections: [
      { h: '1. A szolgáltató adatai és az ÁSZF hatálya', body: [
        ...
        ['**Szolgáltató neve:** {{nameFull}}', '**Székhelye / levelezési címe:** {{address}}', '**Adószáma:** {{taxId}}', '**Nyilvántartási száma:** {{regNumber}}', '**E-mail címe:** {{email}}', '**Telefonszáma:** {{phone}}', '**A szolgáltatás weboldala:** {{siteUrl}}', '**Tárhelyszolgáltató:** {{hostingFull}}'],
      ...
      { h: '6. Árak, fizetés, számlázás', body: [
        ...
        'A Szolgáltató a kifizetett díjról **számlát** állít ki, amelyet a Felhasználó a Fiók oldalon elektronikus (PDF) formában tölthet le. A számla a Felhasználó által a fizetési oldalon megadott számlázási névre és címre szól; ezek helyességéért a Felhasználó felel. A számla a Fiók oldalon {{invoiceKeep}} tölthető le{{invoiceDelete}}, ezért kérjük, mentsd el a számlát. A Szolgáltatót terhelő jogszabályi megőrzési kötelezettségeket a Szolgáltató a rendszeren kívül is teljesítheti. Az elektronikus számla elfogadásával a Felhasználó egyetért.',
  ...
  privacy: {
    ...
    sections: [
      { h: '1. Az adatkezelő adatai', body: [
        ...
        ['**Név:** {{nameFull}}', '**Székhely / levelezési cím:** {{address}}', '**Adószám:** {{taxId}}', '**Nyilvántartási szám:** {{regNumber}}', '**E-mail (adatvédelmi kérdések, kérelmek):** {{email}}', '**Telefon:** {{phone}}', '**Weboldal:** {{siteUrl}}'],
  ...
  imprint: {
    ...
    sections: [
      { h: 'A szolgáltató adatai', body: [
        ['**Név:** {{nameFull}}', '**Székhely / levelezési cím:** {{address}}', '**Adószám:** {{taxId}}', '**Nyilvántartási szám:** {{regNumber}}', '**E-mail cím:** {{email}}', '**Telefonszám:** {{phone}}', '**Weboldal:** {{siteUrl}}'],
      ...
      { h: 'Tárhelyszolgáltató és üzemeltetés', body: [
        ['**Az alkalmazás (szerver) tárhelyszolgáltatója:** {{hostingFull}}', '**A weboldal statikus fájljainak tárhelye:** GitHub, Inc. (GitHub Pages), 88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, USA', '**Domain-szolgáltató:** a domain (impix.hu) nyilvántartója és DNS-szolgáltatója: Rackhost'],
      ] },
